			...
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" runat="server">
					<div class="wrap-input100 validate-input m-b-26" data-validate="Username is required">
                        ...
                        <asp:TextBox ID="TextBox1" runat="server" CssClass="input100" placeholder="Kullanıcı Adınız..." value="admin"></asp:TextBox>
						<span class="focus-input100"></span>
					</div>

					<div class="wrap-input100 validate-input m-b-18" data-validate = "Password is required">
						<span class="label-input100">Şifreniz</span>
                        <asp:TextBox ID="TextBox2" runat="server" CssClass="input100" placeholder="Şifreniz..." TextMode="Password" value="123456"></asp:TextBox>
						<span class="focus-input100"></span>
					</div>
